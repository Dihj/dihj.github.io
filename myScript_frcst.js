...
function rr_normale(){
    ...
    if(le_mois!="00"){
        document.getElementById("sary_paramrr").innerHTML = "<img src='img/FRCST/" + le_mois + ".png' style='width:500px;' />";
...
function tn_normale(){
    ...
    var le_mois = tn;
    if(le_mois!="00"){
        document.getElementById("sary_paramtn").innerHTML = "<img src='img/FRCST/" + le_mois + ".png' style='width:500px;' />";
    }
    else
        alert("Veuillez choisir un mois");
}
...
function tx_normale(){
    ...
    var le_mois = tx;
    if(le_mois!="00"){
        document.getElementById("sary_paramtx").innerHTML = "<img src='img/" + le_mois + ".jpg' style='width:500px;' />";
    }
    else
        alert("Veuillez choisir un mois");
}
